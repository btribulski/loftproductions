 ...
 */
function loftproductions_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['loftproductions_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('loftproductions sample setting'),
  '#default_value' => theme_get_setting('loftproductions_example'),
